  ...
  const BreathingExercise: React.FC = () => (
    <div className="card mb-8">
      ...
      {breathingExercise.isRunning ? (
        ...
        <>
          <p>Техника "4-7-8" для быстрого расслабления и снижения стресса:</p>
          <div style={{ 
            padding: '16px', 
            backgroundColor: 'rgba(0, 102, 255, 0.1)',
            borderRadius: '8px',
  ...
  return (
    <div className="container">
      <div className="card text-center mb-8">
        <h2 className="mb-4">Релаксация и медитация</h2>
        <p>Техники для расслабления и снятия стресса</p>
      </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '16px' }}>
          {[
            ...
            },
            {
              ...
              description: 'Техника для быстрого снятия физического и психологического напряжения, помогает восстановить энергию.',
              steps: [
            ...
            },
            {
              ...
              description: 'Мощная техника для снятия тревоги и стресса через создание мысленного образа места, вызывающего чувство безопасности и комфорта.',
              steps: [
